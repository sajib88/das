<!-- /.container-fluid -->
<footer class="footer text-center"> 2018 &copy; Bangladesh University of Professional. BUP </footer>
</div>
<!-- ============================================================== -->
<!-- End Page Content -->
<!-- ============================================================== -->
...
<!--<script src="assets/js/video/videojs-ie8.min.js"></script>-->

<!--Video end-->

<!--Lightbox-->
<script src="<?php echo base_url(); ?>assets/js/image/ekko-lightbox.js"></script>
<!--<script src="assets/js/image/ekko-lightbox.js.map"></script>-->
<script src="<?php echo base_url(); ?>page_javascript/dashboard/lightbox.js"></script>
<!--Lightbox End-->

<!--Audio-->

<script src="<?php echo base_url(); ?>assets/js/audio/src/js/jquery.mkhplayer.js"></script>
<script src="<?php echo base_url(); ?>page_javascript/dashboard/audio.js"></script>
...
<script src="<?php echo base_url(); ?>assets/plugins/bower_components/sticky/jquery.sticky.js"></script>
